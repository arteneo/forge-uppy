...
2. `v5` - branch for version `5.x` (React 18 and Uppy 6 with Vite which ships ESM build)
3. `v4` - branch for version `4.x` (React 18 and Uppy 3 with Vite which ships ESM build)
4. `v3` - branch for version `3.x` (React 18 and Uppy 3 with webpack which ships UMD build)
5. `v2` - branch for version `2.x` (React 17 and Uppy 3 with webpack which ships UMD build)
